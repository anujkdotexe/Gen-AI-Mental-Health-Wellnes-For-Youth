...
def init_db():
    ...
    try:
        ...
        if not existing_models:
            ...
            ai_models = [
                AIModel(
                    name="Hugging Face RoBERTa Sentiment",
                    model_type="sentiment",
                    model_path="cardiffnlp/twitter-roberta-base-sentiment-latest",
                    version="1.0",
                    is_active=True,
                    performance_metrics=json.dumps({"accuracy": 0.89, "safety": 0.98})
                ),
                AIModel(
                    ...
                    version="1.5",
                    is_active=True,
                    performance_metrics=json.dumps({"accuracy": 0.92, "safety": 0.97})
                ),
                AIModel(
                    ...
                    version="1.5",
                    is_active=True,
                    performance_metrics=json.dumps({"accuracy": 0.88, "safety": 0.96})
                ),
                AIModel(
